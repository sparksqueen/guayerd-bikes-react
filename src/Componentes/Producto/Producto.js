      ...
      <div className="card col-sm-4 ">
        <img src="./Bici-1.png" class="card-img-top"  alt="logo" />
          <div lassName="card-body px-5">
            ...
            <p lassName="card-text">Bicicleta de competición hecha a medida con lo mejor, cuadro francés Huret talle 'M'cambios y mecánica Shimano (shifters, descarriladores), frenos Weinmann...</p>
            <Link to={"#"}class="card-link">Ver Más </Link>
         </div> 
      </div>
